function Hero() {
  return (
    <section id="home" className="px-8 pt-32 pb-16 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-screen">
      {/* LEFT CONTENT */}
      <div className="space-y-6 hero-content pl-8 md:pl-12">
        ...
        <p className="hero-description text-gray-300 leading-relaxed text-sm md:text-base max-w-2xl">
          I'm a Data Scientist and AI/ML Engineer with 5+ years of experience delivering AI-driven solutions across finance, healthcare, insurance, and retail. For me, data science isn't just a job — it's a responsibility. I take full ownership of the systems I build, ensuring they don't just work, but create measurable impact. My journey started in business and marketing, where I realized that every decision, at its core, is powered by data. That curiosity led me to AI, where I found my purpose: solving complex problems that drive real change. I'm driven by discipline, curiosity, and a belief that growth comes from tackling hard problems. I'm constantly exploring new frameworks, reading new papers, and pushing boundaries to build intelligent systems that move businesses forward.
        </p>

        <div className="flex gap-4 pt-4">
          <button className="bg-[#4fc3f7] text-black px-6 py-3 rounded font-semibold hover:bg-[#29b6f6] transition-colors flex items-center gap-2">
            View My Work
            <span>↓</span>
          </button>
          <button className="border border-gray-600 text-gray-300 px-6 py-3 rounded hover:border-[#4fc3f7] hover:text-[#4fc3f7] transition-colors flex items-center gap-2">
            <span>📄</span>
            Download Resume
          </button>
        </div>
        ...
        {/* STATS */}
        <div className="stats-container flex gap-8 md:gap-12 pt-8 flex-wrap">
